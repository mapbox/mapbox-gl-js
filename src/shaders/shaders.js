...
import globeStarsFrag from './globe_stars.fragment.glsl';
import globeStarsVert from './globe_stars.vertex.glsl';
...
export default {
    ...
    globeStars: compile(globeStarsFrag, globeStarsVert)
};
