 ...
 * @private
 */
class StructArrayLayout3i4f1i1ul2ui36 extends StructArray {
    uint8: Uint8Array;
    int16: Int16Array;
    float32: Float32Array;
    uint32: Uint32Array;
    ...
    emplace(i: number, v0: number, v1: number, v2: number, v3: number, v4: number, v5: number, v6: number, v7: number, v8: number, v9: number, v10: number) {
        ...
        this.float32[o4 + 5] = v6;
        this.int16[o2 + 12] = v7;
        this.uint32[o4 + 7] = v8;
        this.uint16[o2 + 16] = v9;
        this.uint16[o2 + 17] = v10;
        return i;
    }
}

StructArrayLayout3i4f1i1ul2ui36.prototype.bytesPerElement = 36;
register('StructArrayLayout3i4f1i1ul2ui36', StructArrayLayout3i4f1i1ul2ui36);
 ...
 * @private
 */
class StructArrayLayout3i3i2i20 extends StructArray {
    uint8: Uint8Array;
    int16: Int16Array;
...
StructArrayLayout3i3i2i20.prototype.bytesPerElement = 20;
register('StructArrayLayout3i3i2i20', StructArrayLayout3i3i2i20);
 ...
 * @private
 */
class StructArrayLayout5i2ui3ul3ui2f3ub1ul1i1ub56 extends StructArray {
    uint8: Uint8Array;
    int16: Int16Array;
    uint16: Uint16Array;
    uint32: Uint32Array;
    ...
    emplace(i: number, v0: number, v1: number, v2: number, v3: number, v4: number, v5: number, v6: number, v7: number, v8: number, v9: number, v10: number, v11: number, v12: number, v13: number, v14: number, v15: number, v16: number, v17: number, v18: number, v19: number, v20: number) {
        ...
        this.uint32[o4 + 5] = v8;
        this.uint32[o4 + 6] = v9;
        this.uint16[o2 + 14] = v10;
        this.uint16[o2 + 15] = v11;
        this.uint16[o2 + 16] = v12;
        this.float32[o4 + 9] = v13;
        this.float32[o4 + 10] = v14;
        this.uint8[o1 + 44] = v15;
        this.uint8[o1 + 45] = v16;
        this.uint8[o1 + 46] = v17;
        this.uint32[o4 + 12] = v18;
        this.int16[o2 + 26] = v19;
        this.uint8[o1 + 54] = v20;
        return i;
    }
}

StructArrayLayout5i2ui3ul3ui2f3ub1ul1i1ub56.prototype.bytesPerElement = 56;
register('StructArrayLayout5i2ui3ul3ui2f3ub1ul1i1ub56', StructArrayLayout5i2ui3ul3ui2f3ub1ul1i1ub56);
 ...
 * @private
 */
class StructArrayLayout11i15ui1ul3f68 extends StructArray {
    uint8: Uint8Array;
    int16: Int16Array;
    uint16: Uint16Array;
    uint32: Uint32Array;
    ...
    emplace(i: number, v0: number, v1: number, v2: number, v3: number, v4: number, v5: number, v6: number, v7: number, v8: number, v9: number, v10: number, v11: number, v12: number, v13: number, v14: number, v15: number, v16: number, v17: number, v18: number, v19: number, v20: number, v21: number, v22: number, v23: number, v24: number, v25: number, v26: number, v27: number, v28: number, v29: number) {
        ...
        this.uint16[o2 + 23] = v23;
        this.uint16[o2 + 24] = v24;
        this.uint16[o2 + 25] = v25;
        this.uint32[o4 + 13] = v26;
        this.float32[o4 + 14] = v27;
        this.float32[o4 + 15] = v28;
        this.float32[o4 + 16] = v29;
        return i;
    }
}

StructArrayLayout11i15ui1ul3f68.prototype.bytesPerElement = 68;
register('StructArrayLayout11i15ui1ul3f68', StructArrayLayout11i15ui1ul3f68);
...
class CollisionBoxStruct extends Struct {
    ...
    get x1() { return this._structArray.float32[this._pos4 + 2]; }
    get y1() { return this._structArray.float32[this._pos4 + 3]; }
    get x2() { return this._structArray.float32[this._pos4 + 4]; }
    get y2() { return this._structArray.float32[this._pos4 + 5]; }
    get padding() { return this._structArray.int16[this._pos2 + 12]; }
    get featureIndex() { return this._structArray.uint32[this._pos4 + 7]; }
    get sourceLayerIndex() { return this._structArray.uint16[this._pos2 + 16]; }
    get bucketIndex() { return this._structArray.uint16[this._pos2 + 17]; }
    get anchorPoint() { return new Point(this.anchorPointX, this.anchorPointY); }
}

CollisionBoxStruct.prototype.size = 36;
 ...
 * @private
 */
export class CollisionBoxArray extends StructArrayLayout3i4f1i1ul2ui36 {
    /**
...
class PlacedSymbolStruct extends Struct {
    ...
    get anchorZ() { return this._structArray.int16[this._pos2 + 2]; }
    get tileAnchorX() { return this._structArray.int16[this._pos2 + 3]; }
    get tileAnchorY() { return this._structArray.int16[this._pos2 + 4]; }
    get glyphStartIndex() { return this._structArray.uint16[this._pos2 + 5]; }
    get numGlyphs() { return this._structArray.uint16[this._pos2 + 6]; }
    get vertexStartIndex() { return this._structArray.uint32[this._pos4 + 4]; }
    get lineStartIndex() { return this._structArray.uint32[this._pos4 + 5]; }
    get lineLength() { return this._structArray.uint32[this._pos4 + 6]; }
    get segment() { return this._structArray.uint16[this._pos2 + 14]; }
    get lowerSize() { return this._structArray.uint16[this._pos2 + 15]; }
    get upperSize() { return this._structArray.uint16[this._pos2 + 16]; }
    get lineOffsetX() { return this._structArray.float32[this._pos4 + 9]; }
    get lineOffsetY() { return this._structArray.float32[this._pos4 + 10]; }
    ...
    get hidden() { return this._structArray.uint8[this._pos1 + 46]; }
    set hidden(x: number) { this._structArray.uint8[this._pos1 + 46] = x; }
    ...
    get associatedIconIndex() { return this._structArray.int16[this._pos2 + 26]; }
    get flipState() { return this._structArray.uint8[this._pos1 + 54]; }
    set flipState(x: number) { this._structArray.uint8[this._pos1 + 54] = x; }
}

PlacedSymbolStruct.prototype.size = 56;
 ...
 * @private
 */
export class PlacedSymbolArray extends StructArrayLayout5i2ui3ul3ui2f3ub1ul1i1ub56 {
    /**
...
class SymbolInstanceStruct extends Struct {
    ...
    get tileAnchorX() { return this._structArray.int16[this._pos2 + 3]; }
    get tileAnchorY() { return this._structArray.int16[this._pos2 + 4]; }
    get rightJustifiedTextSymbolIndex() { return this._structArray.int16[this._pos2 + 5]; }
    get centerJustifiedTextSymbolIndex() { return this._structArray.int16[this._pos2 + 6]; }
    get leftJustifiedTextSymbolIndex() { return this._structArray.int16[this._pos2 + 7]; }
    get verticalPlacedTextSymbolIndex() { return this._structArray.int16[this._pos2 + 8]; }
    get placedIconSymbolIndex() { return this._structArray.int16[this._pos2 + 9]; }
    get verticalPlacedIconSymbolIndex() { return this._structArray.int16[this._pos2 + 10]; }
    get key() { return this._structArray.uint16[this._pos2 + 11]; }
    get textBoxStartIndex() { return this._structArray.uint16[this._pos2 + 12]; }
    get textBoxEndIndex() { return this._structArray.uint16[this._pos2 + 13]; }
    get verticalTextBoxStartIndex() { return this._structArray.uint16[this._pos2 + 14]; }
    get verticalTextBoxEndIndex() { return this._structArray.uint16[this._pos2 + 15]; }
    get iconBoxStartIndex() { return this._structArray.uint16[this._pos2 + 16]; }
    get iconBoxEndIndex() { return this._structArray.uint16[this._pos2 + 17]; }
    get verticalIconBoxStartIndex() { return this._structArray.uint16[this._pos2 + 18]; }
    get verticalIconBoxEndIndex() { return this._structArray.uint16[this._pos2 + 19]; }
    get featureIndex() { return this._structArray.uint16[this._pos2 + 20]; }
    get numHorizontalGlyphVertices() { return this._structArray.uint16[this._pos2 + 21]; }
    get numVerticalGlyphVertices() { return this._structArray.uint16[this._pos2 + 22]; }
    get numIconVertices() { return this._structArray.uint16[this._pos2 + 23]; }
    get numVerticalIconVertices() { return this._structArray.uint16[this._pos2 + 24]; }
    get useRuntimeCollisionCircles() { return this._structArray.uint16[this._pos2 + 25]; }
 ...
 * @private
 */
export class SymbolInstanceArray extends StructArrayLayout11i15ui1ul3f68 {
    /**
...
export {
    ...
    StructArrayLayout3i4f1i1ul2ui36,
    StructArrayLayout3i3i2i20,
    StructArrayLayout2f1f2i16,
    StructArrayLayout2ub2f12,
    StructArrayLayout3ui6,
    StructArrayLayout5i2ui3ul3ui2f3ub1ul1i1ub56,
    StructArrayLayout11i15ui1ul3f68,
    ...
    StructArrayLayout3i3i2i20 as CollisionBoxLayoutArray,
