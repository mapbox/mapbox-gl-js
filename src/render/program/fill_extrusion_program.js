...
const fillExtrusionUniforms = (context: Context, locations: UniformLocations): FillExtrusionUniformsType => ({
    ...
    'u_is_opaque_pass': new Uniform1i(context, locations.u_is_opaque_pass),
});
...
const fillExtrusionPatternUniformValues = (
    ...
    return extend(fillExtrusionUniformValues(matrix, painter, shouldUseVerticalGradient, isOpaquePass),
