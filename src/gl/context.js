...
class Context {
    ...
    setFaceCullingMode(mode: $ReadOnly<FaceCullingMode>) {
        const gl = this.gl;
        this.cullFace.set(mode.cullFace);
        this.cullFaceMode.set(mode.cullFaceMode ? mode.cullFaceMode : gl.BACK);
        this.frontFace.set(mode.frontFace ? mode.frontFace : gl.CCW);
    }
