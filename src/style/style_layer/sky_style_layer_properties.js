...
export type PaintProps = {|
    ...
    "sky-atmosphere-fog-intensity": DataConstantProperty<number>,
    "sky-atmosphere-fog-start": DataConstantProperty<number>,
    "sky-atmosphere-fog-blend": DataConstantProperty<number>,
    "sky-atmosphere-fog-end": DataConstantProperty<number>,
    "sky-atmosphere-fog-color": DataConstantProperty<Color>,
...
const paint: Properties<PaintProps> = new Properties({
    ...
    "sky-atmosphere-fog-intensity": new DataConstantProperty(styleSpec["paint_sky"]["sky-atmosphere-fog-intensity"]),
    "sky-atmosphere-fog-start": new DataConstantProperty(styleSpec["paint_sky"]["sky-atmosphere-fog-start"]),
    "sky-atmosphere-fog-blend": new DataConstantProperty(styleSpec["paint_sky"]["sky-atmosphere-fog-blend"]),
    "sky-atmosphere-fog-end": new DataConstantProperty(styleSpec["paint_sky"]["sky-atmosphere-fog-end"]),
    "sky-atmosphere-fog-color": new DataConstantProperty(styleSpec["paint_sky"]["sky-atmosphere-fog-color"]),
