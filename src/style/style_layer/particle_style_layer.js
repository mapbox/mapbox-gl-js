...
import ParticleBucket from '../../data/bucket/particle_bucket.js';
...
import properties from './particle_style_layer_properties.js';
...
class ParticleStyleLayer extends StyleLayer {
    ...
    createBucket(parameters: BucketParameters<*>) {
        return new ParticleBucket(parameters);
    }
    ...
    queryIntersectsFeature(queryGeometry: TilespaceQueryGeometry,
        ...
        const translation = tilespaceTranslate(
            this.paint.get('particle-translate'),
...
export default ParticleStyleLayer;
