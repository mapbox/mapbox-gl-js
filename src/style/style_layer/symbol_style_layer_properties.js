...
export type LayoutProps = {|
    ...
    "text-variable-anchor-animation": DataConstantProperty<boolean>,
...
const layout: Properties<LayoutProps> = new Properties({
    ...
    "text-variable-anchor-animation": new DataConstantProperty(styleSpec["layout_symbol"]["text-variable-anchor-animation"]),
