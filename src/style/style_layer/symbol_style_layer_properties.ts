...
export type PaintProps = {
    ...
    "icon-occlusion-opacity": DataConstantProperty<number>;
    ...
    "text-occlusion-opacity": DataConstantProperty<number>;
...
const paint: Properties<PaintProps> = new Properties({
    ...
    "icon-occlusion-opacity": new DataConstantProperty(styleSpec["paint_symbol"]["icon-occlusion-opacity"]),
    ...
    "text-occlusion-opacity": new DataConstantProperty(styleSpec["paint_symbol"]["text-occlusion-opacity"]),
