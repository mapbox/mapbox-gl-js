...
export type PaintProps = {|
    ...
    "raster-stretch-min": DataConstantProperty<number>,
    "raster-stretch-max": DataConstantProperty<number>,
...
const paint: Properties<PaintProps> = new Properties({
    ...
    "raster-stretch-min": new DataConstantProperty(styleSpec["paint_raster"]["raster-stretch-min"]),
    "raster-stretch-max": new DataConstantProperty(styleSpec["paint_raster"]["raster-stretch-max"]),
