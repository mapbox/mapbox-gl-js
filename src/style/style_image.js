 ...
 * @property {Uint8Array | Uint8ClampedArray} data Byte array representing the image. Size must be width × height × 4 (to ensure space for all four channels in an RGBA color)
 *
