...
### 🐛 Bug fixes
* Fix a broken module import wheren the `style-spec` package was importing files from `mapbox-gl-js`, its parent repo, causing downstream build systems to break. ([#9522](https://github.com/mapbox/mapbox-gl-js/pull/9522))
