...
* Add `distance` expression entry in `style-spec`, which returns the shortest distance between a feature and an input geometry ([#9655](https://github.com/mapbox/mapbox-gl-js/pull/9655))
