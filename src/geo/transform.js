...
class Transform {
    ...
    _updateCenterElevation(): boolean {
        ...
        const elevationAtCenter = this._elevation.getAtPoint(MercatorCoordinate.fromLngLat(this.center), -1) || 0;
    ...
    _updateZoomFromElevation() {
        ...
        const elevationAtCenter = this._elevation.getAtPoint(MercatorCoordinate.fromLngLat(this.center), 0) || 0;
    ...
    _coordinatePoint(coord: MercatorCoordinate, sampleTerrainIn3D: boolean) {
        const elevation = sampleTerrainIn3D && this.elevation ? this.elevation.getAtPoint(coord, this._centerAltitude || 0) || 0 : this._centerAltitude;
    ...
    _constrainCameraAltitude() {
        ...
        const elevation: Elevation = this._elevation;
        this._updateCameraState();
        const elevationAtCamera = elevation.getAtPoint(this._camera.mercatorPosition, 0) || 0;
