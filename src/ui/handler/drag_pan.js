...
class DragPanHandler {
    ...
    _start(e: MouseEvent | TouchEvent) {
        ...
        this._startTouch = this._lastTouch = DOM.isTouchEvent(e) ? DOM.touchPos(this._el, e) : null;
    ...
    _onMove(e: MouseEvent | TouchEvent) {
        ...
        const touchPos = DOM.isTouchEvent(e) ? DOM.touchPos(this._el, e) : null;
    ...
    _abort(e: FocusEvent | MouseEvent | TouchEvent) {
        ...
        case 'active':
            ...
            this._unbind();
            this._deactivate();
            if (DOM.isTouchEvent(e) && e.touches.length > 1) {
