 ...
 * @param {HTMLElement|string} [options.container=null] The HTML element in which Mapbox GL JS will render the map, or the element's string `id`. The specified element must have no children.
