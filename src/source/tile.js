...
class Tile {
    ...
    redoPlacement(source: any, showCollisionBoxes: boolean, collisionTile: ?CollisionTile, layer: any, posMatrix: Float32Array) {
        ...
        if (bucket) {
            ...
            PlaceSymbols.updateOpacities(bucket, this.coord);
        }
