...
class SourceCache extends Evented {
    ...
    redoPlacement(viewportCollisionTile, symbolOpacityIndex, layer, posMatrices, transform, opacityOnly) {
        ...
        for (let i = 0; i < ids.length; i++) {
            ...
            tile.redoPlacement(this._source, viewportCollisionTile, symbolOpacityIndex, layer, posMatrices[i], opacityOnly);
        }
    }
