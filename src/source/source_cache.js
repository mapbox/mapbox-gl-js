...
class SourceCache extends Evented {
    ...
    redoPlacement(viewportCollisionTile, showCollisionBoxes, layer, posMatrices, transform) {
        ...
        for (let i = 0; i < ids.length; i++) {
            ...
            tile.redoPlacement(this._source, showCollisionBoxes, viewportCollisionTile, layer, posMatrices[i]);
        }
    }
