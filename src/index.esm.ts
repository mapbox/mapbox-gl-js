...
export type {CustomLayerInterface, CustomLayerRenderParameters} from './style/style_layer/custom_style_layer';
...
export type {MapOptions, IControl, ControlPosition, ControlOffset, AddControlOptions} from './ui/map';
