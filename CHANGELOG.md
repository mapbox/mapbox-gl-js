...
* Simplify `clusterProperties` expression ([#7784](https://github.com/mapbox/mapbox-gl-js/pull/7784))
...
* Remove `Array.find` so IE11 works ok (#7837) ([#7838](https://github.com/mapbox/mapbox-gl-js/pull/7838))
