...
* Use a more compact line attributes layout to improve performance ([#8306](https://github.com/mapbox/mapbox-gl-js/pull/8306))
...
* Add `trackPointer` method to `Popup` API that repositions the popup to the mouse cursor when the cursor is within the map ([#7786](https://github.com/mapbox/mapbox-gl-js/pull/7786))
...
* Add a `cacheKeys` option to `groupByLayout` function to cache keys in `style-layer-index` for improved performance ([#8122](https://github.com/mapbox/mapbox-gl-js/pull/8122)) (h/t [vallendm](https://github.com/vallendm))
...
* Add touch drag support for `NavigationControl`'s compass button and add pitch indication to icon ([#8226](https://github.com/mapbox/mapbox-gl-js/pull/8226)) (h/t [pakastin](https://github.com/pakastin))
...
* Fix documentation of Popup `maxWidth` property ([#8312](https://github.com/mapbox/mapbox-gl-js/pull/8312)) (h/t [viniciuskneves](https://github.com/viniciuskneves))
