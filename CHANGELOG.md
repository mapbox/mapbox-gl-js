...
* Add support for cameraForBounds with globe view ([#12138](https://github.com/mapbox/mapbox-gl-js/pull/12138))
...
* Improve the globe bounds calculation ([#12286](https://github.com/mapbox/mapbox-gl-js/pull/12286))
...
* Fix occasional artifacts appearing in the ocean with terrain or globe enabled. ([#12203](https://github.com/mapbox/mapbox-gl-js/pull/12203))
...
* Fix missing ocean tiles when globe is enabled. ([#12279](https://github.com/mapbox/mapbox-gl-js/pull/12279))
