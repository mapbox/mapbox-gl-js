        ...
        objectElementValidators: {
            ...
            layout: function(options) {
                return validateObject({
                    ...
                    style: options.style,
                    styleSpec: options.styleSpec,
                    objectElementValidator: function(options) {
                        return validateLayoutProperty(extend({layer: layer}, options));
                    }
                });
            },
            paint: function(options) {
                return validateObject({
                    ...
                    styleSpec: options.styleSpec,
                    objectElementValidator: function(options) {
                        return validatePaintProperty(extend({layer: layer}, options));
                    }
                });
            }
        }
