window.style = {
  ...
  "buckets": {
    ...
    "waterway_river": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "waterway", "type": "river"},
      "line": true,
      "line-cap": "round"
    },
    "waterway_stream_canal": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "waterway", "type": ["stream", "canal"]},
      "line": true,
      "line-cap": "round"
    },
    "landuse_park": {
    ...
    "landuse_cemetary": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "landuse", "class": "cemetary"},
      "fill": true
    },
    "landuse_hospital": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "landuse", "class": "hospital"},
      "fill": true
    },
    "landuse_school": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "landuse", "class": "school"},
      "fill": true
    },
    "landuse_wood": {
    ...
    "aeroway_fill": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "aeroway"},
      "fill": true,
      "min-zoom": 12
    },
    "aeroway_runway": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "aeroway", "type": "runway"},
      "line": true,
      "min-zoom": 12
    },
    "aeroway_taxiway": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "aeroway", "type": "taxiway"},
      "line": true,
      "min-zoom": 12
    },
    "building": {
    ...
    "tunnel_motorway_link": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "tunnel", "class": "motorway_link"},
      "line": true,
      "line-cap": "round",
      "line-join": "round"
    },
    "tunnel_motorway": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "tunnel", "class": "motorway"},
      "line": true,
      "line-cap": "round",
      "line-join": "round"
    },
    "tunnel_path": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "tunnel", "class": "path"}
    },
    "tunnel_major_rail": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "tunnel", "class": "major_rail"},
      "line": true
    },
    "tunnel_service": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "tunnel", "class": "service"},
      "line": true,
      "min-zoom": 15,
      "line-cap": "round",
      "line-join": "round"
    ...
    "tunnel_main": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "tunnel", "class": "main"},
      "line": true,
      "line-cap": "round",
      "line-join": "round"
    },
    ...
    "road_motorway_link": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "road", "class": "motorway_link"},
      "line": true,
      "line-cap": "round",
      "line-join": "round"
    },
    "road_service": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "road", "class": "service"},
      "line": true,
      "min-zoom": 15,
      "line-cap": "round",
      "line-join": "round"
    ...
    "road_main": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "road", "class": "main"},
      "line": true,
      "line-cap": "round",
      "line-join": "round"
    },
    "road_street": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "road", "class": ["street", "street_limited"]},
      "line": true,
      "min-zoom": 12,
      "line-cap": "round",
      "line-join": "round"
    ...
    "road_motorway": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "road", "class": "motorway"},
      "line": true,
      "line-cap": "round",
      "line-join": "round"
    },
    "bridge_service": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "bridge", "class": "service"},
      "line": true,
      "min-zoom": 15,
      "line-join": "round"
    },
    "bridge_main": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "bridge", "class": "main"},
      "line": true,
      "line-join": "round"
    },
    "bridge_street": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "bridge", "class": ["street", "street_limited"]},
      "line": true,
      "min-zoom": 12,
      "line-join": "round"
    },
    "bridge_motorway_link": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "bridge", "class": "motorway_link"},
      "line": true,
      "line-join": "round"
    },
    "bridge_motorway": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "bridge", "class": "motorway"},
      "line": true,
      "line-join": "round"
    },
    "road_path": {
    ...
    "bridge_path": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "bridge", "class": "path"},
      "line": true,
      "min-zoom": 15
    },
    "bridge_major_rail": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "bridge", "class": "major_rail"},
      "line": true
    },
    "admin_level_3": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "admin", "admin_level": [3, 4, 5]},
      "line": true,
      "line-join": "round"
    },
    "admin_level_2": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "admin", "admin_level": 2},
      "line": true,
      "line-cap": "round",
      "line-join": "round"
    },
    "admin_maritime": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "admin", "maritime": "1"},
      "line": true,
      "line-join": "round"
    },
    "country_label_line": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "country_label_line"},
      "line": true,
      "min-zoom": 3
    },
    "country_label": {
    ...
    "marin_label_1": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "marin_label", "labelrank": 1, "feature_type": "line"},
      "text": true,
      "text-font": "Open Sans Regular, Arial Unicode MS Regular",
      "text-field": "{{name}}",
      "text-max-size": 22,
    ...
    "marin_label_2": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "marin_label", "labelrank": 2, "feature_type": "line"},
      "text": true,
      "text-font": "Open Sans Regular, Arial Unicode MS Regular",
      "text-field": "{{name}}",
      "text-max-size": 16,
    ...
    "marin_label_3": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "marin_label", "labelrank": 3, "feature_type": "line"},
      "text": true,
      "text-field": "{{name}}",
      "text-max-size": 14,
      "text-path": "curve"
    ...
    "place_label_city_point": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "place_label", "type": "city"},
      "point": true
    },
    "place_label_city": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "place_label", "type": "city", "feature_type": "point"},
      "text": true,
      "text-font": "Open Sans Regular, Arial Unicode MS Regular",
      "text-field": "{{name}}",
      "text-max-size": 24,
    ...
    "place_label_town": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "place_label", "type": "town", "feature_type": "point"},
      "text": true,
      "text-font": "Open Sans Regular, Arial Unicode MS Regular",
      "text-field": "{{name}}",
      "text-max-size": 24,
    ...
    "poi_label": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "poi_label", "feature_type": "point"},
      "text": true,
      "text-font": "Open Sans Regular, Arial Unicode MS Regular",
      "text-field": "{{name}}",
      "text-max-size": 12,
    ...
    "water_label": {
      "filter": {"source": "mapbox.mapbox-streets-v5", "layer": "water_label", "feature_type": "point"},
      "text": true,
      "text-font": "Open Sans Regular, Arial Unicode MS Regular",
      "text-field": "{{name}}",
      "text-max-size": 12,
