...
GLPainter.prototype.setup = function() {
    ...
    this.rasterShader = gl.initializeShader('raster',
        ['a_pos'],
        ['u_posmatrix', 'u_brightness_low', 'u_brightness_high', 'u_saturation_factor', 'u_spin_weights', 'u_contrast_factor', 'u_mix', 'u_image0', 'u_image1', 'u_tl_parent', 'u_scale_parent']);
