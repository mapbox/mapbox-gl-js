...
module.exports = {
    ...
    addLine: function(vertices, join, cap, miterLimit, roundLimit) {
    ...
    addCurrentVertex: function(currentVertex, flip, distance, normal, endLeft, endRight, round) {
        var tx = round ? 1 : 0;
        var extrude;
    ...
    addPieSliceVertex: function(currentVertex, flip, distance, extrude, lineTurnsLeft) {
