...
var ElementGroups = require('../data/element_groups');
...
module.exports = {
    ...
    addFeatures: function(collisionTile, stacks, icons) {
    ...
    addFeature: function(lines, shapedText, shapedIcon) {
        var layout = this.layoutProperties;
    ...
    anchorIsTooClose: function(text, repeatDistance, anchor) {
    ...
    placeFeatures: function(collisionTile, buffers, collisionDebug) {
    ...
    addSymbolVertex: function(shaderName, x, y, ox, oy, tx, ty, minzoom, maxzoom, labelminzoom) {
        return this['add' + capitalize(shaderName) + 'Vertex'](x, y, ox, oy, tx, ty, minzoom, maxzoom, labelminzoom);
    }
};
