 ...
 * @property {boolean} enabled Whether the "drag to pan" interaction is currently enabled
 * @property {boolean} active Whether the "drag to pan" interaction is currently active
 */
