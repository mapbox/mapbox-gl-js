module.exports = {
  'buckets': {
    ...
    'water': {
      source: 'osm-bright', layer: 'water',
      type: 'fill'
    },
    'waterway_other': {
      source: 'osm-bright', layer: 'waterway',
    ...
    'waterway_river': {
      source: 'osm-bright', layer: 'waterway',
      field: 'type', value: 'river',
      cap: 'round',
      type: 'line'
    },
    'waterway_stream_canal': {
      source: 'osm-bright', layer: 'waterway',
      field: 'type', value: ['stream', 'canal'],
      cap: 'round',
      type: 'line'
    },

    'landuse_park': {
      source: 'osm-bright', layer: 'landuse',
    ...
    'building': {
      source: 'osm-bright', layer: 'building',
      type: 'fill'
    },

    'aeroway_fill': {
      source: 'osm-bright', layer: 'aeroway',
      type: 'fill',
      enabled: 12
    },
    'aeroway_runway': {
    ...
    //tunnels
    'tunnel_motorway': {
      source: 'osm-bright', layer: 'tunnel',
      field: 'class', value: 'motorway',
      join: 'round', cap: 'round',
      type: 'line'
    },
    ...
    //bridges
    'bridge_motorway': {
      source: 'osm-bright', layer: 'bridge',
      field: 'class', value: 'motorway',
      join: 'round',
      type: 'line'
    },
    ...
    // Labels:
    'country_label': {
      source: 'osm-bright', layer: 'country_label',
      text_field: 'name',
      path: 'horizontal',
      fontSize: 13,
    ...
    'country_label_line': {
      source: 'osm-bright', layer: 'country_label_line',
      type: 'line',
      enabled: 3
    },
    'marin_label_1': {
      source: 'osm-bright', layer: 'marin_label',
      field: 'labelrank', value: 1,
    ...
    'place_label_city_point': {
      source: 'osm-bright', layer: 'place_label',
    ...
    'poi_label': {
      source: 'osm-bright', layer: 'poi_label',
      text_field: 'name',
      path: 'horizontal',
      padding: 2,
      fontSize: 12,
    ...
    'road_label': {
      source: 'osm-bright', layer: 'road_label',
      text_field: 'name',
      path: 'curve',
      padding: 2,
      fontSize: 13,
    ...
    'water_label': {
      source: 'osm-bright', layer: 'water_label',
      text_field: 'name',
      path: 'horizontal',
      fontSize: 12,
      feature_type: 'point', type: 'text'
    ...
    'poi_fire_station': {
      source: 'osm-bright', layer: 'poi_label',
      field: 'maki', value: 'fire-station',
      size: {x: 12, y: 12}, type: 'point'
    },
    'poi_bus': {
      source: 'osm-bright', layer: 'poi_label',
      field: 'maki', value: 'bus',
      size: {x: 12, y: 12}, type: 'point'
    },
    'poi_restaurant': {
      source: 'osm-bright', layer: 'poi_label',
      field: 'maki', value: 'restaurant',
      size: {x: 12, y: 12}, type: 'point'
    },
    'poi_park': {
      source: 'osm-bright', layer: 'poi_label',
    ...
    'poi_cafe': {
      source: 'osm-bright', layer: 'poi_label',
      field: 'maki', value: 'cafe',
      size: {x: 12, y: 12}, type: 'point'
    },
    'poi_beer': {
      source: 'osm-bright', layer: 'poi_label',
      field: 'maki', value: 'beer',
      size: {x: 12, y: 12}, type: 'point'
    },
  },
  'constants': {
  ...
  'structure': [
    ...
    {name: 'waterway_other', bucket: 'waterway_other'},
    {name: 'waterway_river', bucket: 'waterway_river'},
    {name: 'waterway_stream_canal', bucket: 'waterway_stream_canal'},
    ...
    {name: 'landuse_wood', bucket: 'landuse_wood'},
    {name: 'water', bucket: 'water'},
    {name: 'water_offset', bucket: 'water'},
    ...
    {name: 'tunnel_path', bucket: 'tunnel_path'},
    {name: 'tunnel_major_rail', bucket: 'tunnel_major_rail'},
    {name: 'tunnel_major_rail_hatching', bucket: 'tunnel_major_rail'},
    ...
    {name: 'road_path', bucket: 'path'},
    {name: 'road_major_rail', bucket: 'major_rail'},
    {name: 'road_major_rail_hatching', bucket: 'major_rail'},

    {name: 'bridge_path', bucket: 'bridge_path'},
    {name: 'bridge_major_rail', bucket: 'bridge_major_rail'},
    {name: 'bridge_major_rail_hatching', bucket: 'bridge_major_rail'},
    ...
    {name: 'marin_label_1', bucket: 'marin_label_1'},
    {name: 'marin_label_2', bucket: 'marin_label_2'},
    {name: 'marin_label_3', bucket: 'marin_label_3'},
    ...
    {name: 'poi_label', bucket: 'poi_label'},
    {name: 'water_label', bucket: 'water_label'},
    {name: 'poi_airport', bucket: 'poi_airport'},
    {name: 'poi_rail', bucket: 'poi_rail'},
    {name: 'poi_bus', bucket: 'poi_bus'},
    {name: 'poi_fire_station', bucket: 'poi_fire_station'},
    {name: 'poi_restaurant', bucket: 'poi_restaurant'},
    {name: 'poi_park', bucket: 'poi_park'},
    {name: 'poi_hospital', bucket: 'poi_hospital'},
    {name: 'poi_playground', bucket: 'poi_playground'},
    {name: 'poi_cafe', bucket: 'poi_cafe'},
    {name: 'poi_beer', bucket: 'poi_beer'}
  ],
  'classes': [
    {
      name: 'default',
      layers: {
        ...
        'poi_airport': {
          color: 'maki', image: 'airport-12', translate: 'point_translate'
        },
        'poi_restaurant': {
          color: 'maki', image: 'restaurant-12', translate: 'point_translate'
        },
        'poi_bus': {
          color: 'maki', image: 'bus-12', translate: 'point_translate'
        },
        'poi_rail': {
          color: 'maki', image: 'rail-12', translate: 'point_translate'
        },
        'poi_fire_station': {
          color: 'maki', image: 'fire-station-12', translate: 'point_translate'
        },
        'poi_park': {
          color: 'maki', image: 'park-12', translate: 'point_translate'
        },
        'poi_hospital': {
          color: 'maki', image: 'hospital-12', translate: 'point_translate'
        },
        'poi_playground': {
          color: 'maki', image: 'playground-12', translate: 'point_translate'
        },
        'poi_cafe': {
