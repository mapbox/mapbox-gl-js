...
const skip = [
    ...
    "render-tests/3d-intersections/bridge-to-tunnel-transition",
    ...
    "render-tests/3d-intersections/elevated-symbols-lighting",
    "render-tests/3d-intersections/elevated-symbols-mixed",
    "render-tests/3d-intersections/elevated-symbols-pitched",
    "render-tests/3d-intersections/elevated-symbols-sdf",
    "render-tests/3d-intersections/elevated-symbols-viewport-aligned",
    "render-tests/3d-intersections/elevated-symbols",
    "render-tests/3d-intersections/elevated-wireframe",
    "render-tests/3d-intersections/fog",
    "render-tests/3d-intersections/guard-rail-color-feature-dependent",
    "render-tests/3d-intersections/guard-rail-color",
    "render-tests/3d-intersections/guard-rail-joint",
    "render-tests/3d-intersections/guard-rail-qkey-border",
    "render-tests/3d-intersections/guard-rail-start",
    "render-tests/3d-intersections/guard-rail-toggle",
    "render-tests/3d-intersections/las-vegas",
    "render-tests/3d-intersections/road-markups-clipping",
    "render-tests/3d-intersections/road-markups-high-pitch",
    "render-tests/3d-intersections/road-markups",
    ...
    "render-tests/3d-intersections/terrain-toggle-on-off",
    "render-tests/3d-intersections/tile-border",
    "render-tests/3d-intersections/tunnel-enterance-color",
    "render-tests/3d-intersections/tunnel-enterance",
    "render-tests/3d-intersections/tunnel-separate-layer",
    "render-tests/3d-intersections/versioning",
    "render-tests/3d-intersections/zLevel/sf-progress",
    "render-tests/3d-intersections/zLevel/tokyo-clip-lines",
    ...
    "render-tests/3d-intersections/munich-close",
    "render-tests/3d-intersections/no-cross-beams",
    "render-tests/3d-intersections/no-light",
    "render-tests/3d-intersections/ortho-camera",
    "render-tests/3d-intersections/palo-alto",
