...
var placeShapedIcons = require('../../../js/symbol/place_shaped_icon');
...
test('placeShapedIcons', function(t) {
    ...
    t.test('point', function(t) {
        ...
        t.deepEqual(placeShapedIcons(anchor, createShapedIcon(), 2, [], layer, false), [
            {
                anchorPoint: { x: 2, y: 3 },
                tl: { x: -8, y: -6 },
                tr: { x: 7, y: -6 },
    ...
    t.test('line', function(t) {
        ...
        t.deepEqual(placeShapedIcons(anchor, createShapedIcon(), 2, [new Point(0, 0), new Point(8, 9)], layer, false), [
            {
                anchorPoint: { x: 2, y: 3},
                tl: { x: -8, y: -6 },
                tr: { x: 7, y: -6 },
...
test('placeShapedIcons text-fit', function(t) {
    ...
    t.test('icon-text-fit: none', function(t) {
        var quads = placeShapedIcons(anchor, createShapedIcon(), 2, [], createLayer({
            layout: {
                'icon-text-fit': 'none'
            }
        ...
        t.deepEqual(quads, placeShapedIcons(anchor, createShapedIcon(), 2, [], createLayer({
            layout: {
                'icon-text-fit': 'none',
