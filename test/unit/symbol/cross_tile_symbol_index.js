...
test('CrossTileSymbolIndex.addLayer', (t) => {
    ...
    t.test('does not duplicate ids within one zoom level', (t) => {
        ...
        t.deepLooseEqual(Object.keys(layerIndex.usedCrossTileIDs[6]), [1, 2]);
        ...
        t.deepLooseEqual(Object.keys(layerIndex.usedCrossTileIDs[6]), []);
        t.deepLooseEqual(Object.keys(layerIndex.usedCrossTileIDs[7]), [1, 2, 3]);
    ...
    t.test('does not regenerate ids for same zoom', (t) => {
        ...
        t.deepLooseEqual(Object.keys(layerIndex.usedCrossTileIDs[6]), [1, 2, 3]);
