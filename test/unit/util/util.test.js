...
test('util', (t) => {
    ...
    t.deepEqual(getAABBOriginSquareDist([2, 2], [3, 3]), 8);
    t.deepEqual(getAABBOriginSquareDist([2, 2], [10, 3]), 8);
    t.deepEqual(getAABBOriginSquareDist([-2, -2], [2, 2]), 0);
