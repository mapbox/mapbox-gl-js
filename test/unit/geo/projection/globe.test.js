    ...
    t.test('coveringTiles', (t) => {
        ...
        t.test('tessellate fewer tiles near pole', (t) => {
            ...
            t.deepEqual(tr.coveringTiles(options), [
                ...
                new OverscaledTileID(4, 0, 4, 3, 1),
                new OverscaledTileID(4, 0, 4, 2, 2),
                new OverscaledTileID(4, 0, 4, 4, 3),
                new OverscaledTileID(4, 0, 4, 4, 1),
                new OverscaledTileID(4, 0, 4, 2, 3),
                new OverscaledTileID(4, 0, 4, 2, 1),
                new OverscaledTileID(4, 0, 4, 5, 2),
                new OverscaledTileID(4, 0, 4, 3, 0),
                new OverscaledTileID(4, 0, 4, 1, 2),
                new OverscaledTileID(4, 0, 4, 5, 1),
                new OverscaledTileID(4, 0, 4, 4, 0),
                new OverscaledTileID(4, 0, 4, 2, 0),
                new OverscaledTileID(4, 0, 4, 1, 1),
                new OverscaledTileID(4, 0, 4, 5, 0),
                new OverscaledTileID(4, 0, 4, 1, 0),
                new OverscaledTileID(4, 0, 4, 6, 1),
                new OverscaledTileID(4, 0, 4, 0, 1),
                new OverscaledTileID(4, 0, 4, 6, 0),
                new OverscaledTileID(4, 0, 4, 0, 0),
                new OverscaledTileID(4, 0, 4, 7, 1),
                new OverscaledTileID(4, 0, 4, 7, 0),
                new OverscaledTileID(4, 0, 4, 8, 2),
                new OverscaledTileID(4, 0, 4, 8, 1),
                new OverscaledTileID(4, 0, 4, 8, 0),
                new OverscaledTileID(4, 0, 4, 9, 2),
                new OverscaledTileID(4, 0, 4, 9, 1),
                new OverscaledTileID(4, 0, 4, 9, 0),
                new OverscaledTileID(4, 0, 4, 10, 1),
                new OverscaledTileID(4, 0, 4, 10, 0),
                new OverscaledTileID(4, 0, 4, 11, 1),
                new OverscaledTileID(4, 0, 4, 11, 0),
                new OverscaledTileID(4, 0, 4, 12, 1),
                new OverscaledTileID(4, 0, 4, 12, 0),
                new OverscaledTileID(4, 0, 4, 13, 2),
                new OverscaledTileID(4, 0, 4, 13, 1),
                new OverscaledTileID(4, 0, 4, 13, 0),
                new OverscaledTileID(4, 0, 4, 14, 2),
                new OverscaledTileID(4, 0, 4, 14, 1),
                new OverscaledTileID(4, 0, 4, 14, 0),
                new OverscaledTileID(4, 0, 4, 15, 2),
                new OverscaledTileID(4, 0, 4, 15, 1),
                new OverscaledTileID(4, 0, 4, 15, 0),
            ]);
            t.end();
        });
        ...
        t.test('ideal tiles at high pitch', (t) => {
            ...
            t.deepEqual(tr.coveringTiles(options), [
                ...
                new OverscaledTileID(5, 0, 5, 27, 12),
                new OverscaledTileID(3, 0, 3, 7, 2),
                new OverscaledTileID(3, 0, 3, 6, 2),
                new OverscaledTileID(5, 0, 5, 0, 12),
