...
import {ElevationFeature, ElevationFeatures, type Edge, type Range, type Vertex} from '../../../src/data/elevation_feature';
...
import {HD_ELEVATION_SOURCE_LAYER} from '../../../src/data/elevation_constants';
...
test('pointElevation', () => {
    const safeArea: Range[] = [
        {min: 0, max: 0}, {min: 32, max: 32}
    ];
    ...
    expect(constantHeightFeature.pointElevation({x: 0, y: 0})).toBe(5.0);
    expect(constantHeightFeature.pointElevation({x: -1000, y: 256})).toBe(5.0);
    ...
    expect(feature.pointElevation({x: -10, y: 0})).toBeCloseTo(0.0, 5);
    expect(feature.pointElevation({x: -10, y: 10})).toBeCloseTo(0.0, 5);
    expect(feature.pointElevation({x: -20, y: 10})).toBeCloseTo(0.0, 5);
    expect(feature.pointElevation({x: 0, y: 0})).toBeCloseTo(1.0, 5);
    expect(feature.pointElevation({x: 0, y: -1})).toBeCloseTo(1.0, 5);
    expect(feature.pointElevation({x: 10, y: 0})).toBeCloseTo(2.0, 5);
    expect(feature.pointElevation({x: 10000, y: 0})).toBeCloseTo(2.0, 5);

    expect(feature.pointElevation({x: -5, y: 0})).toBeCloseTo(0.5, 5);
    expect(feature.pointElevation({x: 2, y: 0})).toBeCloseTo(1.2, 5);
    ...
    expect(curvedFeature.pointElevation({x: 0, y: 0})).toBeCloseTo(0.0, 5);
    expect(curvedFeature.pointElevation({x: -4, y: 1})).toBeCloseTo(0.0, 5);
    expect(curvedFeature.pointElevation({x: 2, y: 1})).toBeCloseTo(-0.64644, 4);
    expect(curvedFeature.pointElevation({x: 6, y: -2})).toBeCloseTo(-1.0, 5);

    expect(curvedFeature.pointElevation({x: 3, y: 2})).toBeCloseTo(-2.0, 5);
    expect(curvedFeature.pointElevation({x: 8, y: 8})).toBeCloseTo(-3.0, 5);

    expect(curvedFeature.pointElevation({x: 2, y: 3})).toBeCloseTo(-3.35355, 4);
    expect(curvedFeature.pointElevation({x: 1, y: 6})).toBeCloseTo(-3.82322, 4);
    expect(curvedFeature.pointElevation({x: -1, y: 6})).toBeCloseTo(-4.0, 5);
});
