...
test('AttributionControl appears in compact mode if container is less then 640 pixel wide', (t) => {
    const map = createMap(t);
    Object.defineProperty(map.getContainer(), 'offsetWidth', {value: 700, configurable: true});
    map.addControl(new AttributionControl());
    ...
    Object.defineProperty(map.getContainer(), 'offsetWidth', {value: 600, configurable: true});
    map.resize();
