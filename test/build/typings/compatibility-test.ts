 ...
 */
// $ExpectType void
new mapboxgl.Map({container: 'div'}).scrollZoom.setZoomRate(1);

// $ExpectType void
new mapboxgl.Map({container: 'div'}).scrollZoom.setWheelZoomRate(1);
new mapboxgl.Map({container: 'div'}).scrollZoom.enable({around: "center"});
