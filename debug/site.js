...
if (typeof document !== 'undefined') {
    var map = window.map = new llmr.Map({
        ...
        sources: {
            "mapbox streets": {
                type: 'vector',
                url: 'http://{s}.gl-api-us-east-1.tilestream.net/v3/mapbox.mapbox-streets-v4/{z}/{x}/{y}.vector.pbf',
                // urls: ['http://api.tiles.mapbox.com/v3/mapbox.mapbox-streets-v4/{z}/{x}/{y}.vector.pbf'],
                glyphs: 'http://{s}.gl-api-us-east-1.tilestream.net/v3/glyph/{fontstack}/{range}.pbf',
                tileSize: 512,
                maxZoom: 14,
                skipZooms: [1, 9, 11]
            },
