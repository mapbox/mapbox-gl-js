...
```html
<script src='https://api.tiles.mapbox.com/mapbox-gl-js/v0.8.2/mapbox-gl.js'></script>
<link href='https://api.tiles.mapbox.com/mapbox-gl-js/v0.8.2/mapbox-gl.css' rel='stylesheet' />
```
