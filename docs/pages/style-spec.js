    ...
    render() {
        return (
            <PageShell meta={meta}>
                ...
                `}</style>
                <div id='docs-content' className='contain prose'>
                    <div>
                        <h1>{meta.title}</h1>
                    ...
                    <div>
                        <a id='root' />
                        <h2><a className='unprose' href='#root' title='link to root'>Root Properties</a></h2>
                    ...
                    <div className='px12 py12'>
                        ...
                        <h2><a className='unprose' href='#light' title='link to light'>Light</a></h2>
                        <p>
                            A style's <code>light</code> property provides global light source for that style.
                        </p>
                        <div className='mb6 px12 py12x clearfix'>
                    ...
                    <div className='px12 py12'>
                        <a id='sources' />
                        <h2><a className='unprose' href='#sources' title='link to sources'>Sources</a></h2>
                        <p>
                    ...
                    <div className='px12 py12'>
                        ...
                        <h2><a className='unprose' href='#sprite' title='link to sprite'>Sprite</a></h2>
                        <p>
                        ...
                        <div className='mb6 px12 py12 clearfix'>
                    ...
                    <div className='px12 py12'>
                        ...
                        <h2><a className='unprose' href='#glyphs' title='link to glyphs'>Glyphs</a></h2>
                        <p>
                    ...
                    <div className='px12 py12'>
                        <a id='transition' ></a>
                        <h2><a className='unprose' href='#transition' title='link to transition'>Transition</a></h2>
                        <p>
                    ...
                    <div className='px12 py12'>
                        <a id='layers' ></a>
                        <h2><a className='unprose' href='#layers' title='link to layers'>Layers</a></h2>
                        <p>
                    ...
                    <div className='px12 py12'>
                        <a id='types' />
                        <h2><a className='unprose' href='#types' title='link to types'>Types</a></h2>
                    ...
                    <div className='px12 py12'>
                        <a id='expressions' />
                        <h2><a className='unprose' href='#expressions' title='link to expressions'>Expressions</a></h2>
