...
import RemovePaintStateKey from '../benchmarks/remove_paint_state_key';
import RemovePaintStateFeature from '../benchmarks/remove_paint_state_feature';
import RemovePaintStateSource from '../benchmarks/remove_paint_state_source';
...
register(new RemovePaintStateKey(center));
register(new RemovePaintStateFeature(center));
register(new RemovePaintStateSource(center));
